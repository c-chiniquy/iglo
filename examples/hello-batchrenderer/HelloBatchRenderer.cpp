...
private:
	...
	void Start()
	{
		...
		rendertarget.Load(context, context.GetWidth(), context.GetHeight(), context.GetBackBufferRenderTargetDesc().colorFormats[0],
			ig::TextureUsage::RenderTexture, ig::MSAA::X8, clearValue);
