...
;
; shader hash: 15162dcbeb5ac9c59f7dfbeded54c0d7
;
...
define void @PSMain() {
  ...
  %20 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %19, i32 0)  ; CBufferLoadLegacy(handle,regIndex)
  %21 = extractvalue %dx.types.CBufRet.f32 %20, 0
  %22 = fadd fast float %21, %4
  %23 = extractvalue %dx.types.CBufRet.f32 %20, 1
  %24 = fmul fast float %22, %23
  %25 = call float @dx.op.unary.f32(i32 13, float %24)  ; Sin(value)
  %26 = fmul fast float %25, 0x3FA99999A0000000
  %27 = fadd fast float %21, %3
  %28 = extractvalue %dx.types.CBufRet.f32 %20, 2
  %29 = fmul fast float %27, %28
  %30 = call float @dx.op.unary.f32(i32 12, float %29)  ; Cos(value)
  %31 = fmul fast float %30, 0x3FA99999A0000000
  %32 = fadd fast float %26, %3
  %33 = fadd fast float %31, %4
  %34 = call %dx.types.ResRet.f32 @dx.op.sample.f32(i32 60, %dx.types.Handle %12, %dx.types.Handle %15, float %32, float %33, float undef, float undef, i32 0, i32 0, i32 undef, float undef)  ; Sample(srv,sampler,coord0,coord1,coord2,coord3,offset0,offset1,offset2,clamp)
  ...
  %39 = fmul fast float %35, %5
  %40 = fmul fast float %36, %6
  %41 = fmul fast float %37, %7
  %42 = fmul fast float %38, %8
...
const unsigned char g_PS_Wobble[] = {
  0x44, 0x58, 0x42, 0x43, 0x65, 0xae, 0x1f, 0x50, 0x98, 0xd2, 0x1d, 0xc4,
  0xfd, 0xc5, 0x24, 0xfd, 0x77, 0xd6, 0xfe, 0x5d, 0x01, 0x00, 0x00, 0x00,
  0xc0, 0x0a, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x38, 0x00, 0x00, 0x00,
  ...
  0x00, 0x00, 0x00, 0x00, 0x15, 0x16, 0x2d, 0xcb, 0xeb, 0x5a, 0xc9, 0xc5,
  0x9f, 0x7d, 0xfb, 0xed, 0xed, 0x54, 0xc0, 0xd7, 0x44, 0x58, 0x49, 0x4c,
  0x94, 0x08, 0x00, 0x00, 0x66, 0x00, 0x00, 0x00, 0x25, 0x02, 0x00, 0x00,
  ...
  0x14, 0xe2, 0x21, 0x16, 0x82, 0xa0, 0x32, 0x0c, 0xc4, 0x40, 0xd2, 0x4d,
  0xc3, 0xe5, 0x4f, 0xd8, 0x43, 0x48, 0xfe, 0x4a, 0x48, 0x2b, 0x31, 0xf9,
  0xc5, 0x6d, 0xa3, 0x62, 0x18, 0x86, 0x81, 0x28, 0x0c, 0x45, 0x2c, 0xcb,
  0x30, 0x0c, 0x03, 0x41, 0x10, 0x03, 0x55, 0x47, 0x0d, 0x97, 0x3f, 0x61,
  0x0f, 0x21, 0xf9, 0xdc, 0x46, 0x15, 0x2b, 0x31, 0xf9, 0xc8, 0x6d, 0x23,
  0x82, 0x20, 0x08, 0xa2, 0x10, 0x17, 0xb1, 0x10, 0x84, 0xdd, 0x36, 0x5c,
  ...
  
};
