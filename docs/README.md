...
> The `Lighting and Shadows` example project demonstrates how to implement basic lighting and shadow mapping in iglo, use multisampled anti-aliasing, and use sRGB formats for more accurate lighting calculations.
